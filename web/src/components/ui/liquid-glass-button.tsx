  ...
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 ease-spring active:scale-[0.96] active:duration-75 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        brand: "bg-gradient-to-r from-[#7C3AED] via-[#9333EA] to-[#EC4899] backdrop-blur-2xl backdrop-saturate-[1.8] border border-white/50 text-white font-bold hover:brightness-110 hover:border-white/80 hover:scale-[1.02] duration-300 transition shadow-[0_10px_35px_rgba(124,58,237,0.35),inset_0_1px_1.5px_rgba(255,255,255,0.7)] hover:shadow-[0_14px_45px_rgba(124,58,237,0.5),inset_0_1px_1.5px_rgba(255,255,255,0.9)]",
        brandNavbar: "bg-white/80 backdrop-blur-2xl backdrop-saturate-[1.8] border border-purple-200/90 text-slate-900 font-bold hover:bg-white hover:border-purple-400 hover:scale-[1.02] duration-300 transition shadow-[0_6px_24px_rgba(124,58,237,0.08),inset_0_1px_1.5px_rgba(255,255,255,0.95)] hover:shadow-[0_10px_32px_rgba(124,58,237,0.18)]",
