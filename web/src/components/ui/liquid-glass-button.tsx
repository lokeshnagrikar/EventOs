  ...
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 ease-spring active:scale-[0.96] active:duration-75 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        brand: "bg-gradient-to-r from-[#7C3AED] via-[#8B5CF6] to-[#A855F7] backdrop-blur-2xl backdrop-saturate-[1.8] border border-white/35 text-white font-bold hover:brightness-110 hover:border-white/60 hover:scale-[1.02] duration-300 transition shadow-[0_8px_30px_rgba(124,58,237,0.35),inset_0_1px_1px_rgba(255,255,255,0.5)] hover:shadow-[0_12px_40px_rgba(124,58,237,0.5),inset_0_1px_1px_rgba(255,255,255,0.7)]",
        brandNavbar: "bg-gradient-to-r from-white/90 via-slate-50/90 to-purple-50/80 backdrop-blur-2xl backdrop-saturate-[1.8] border border-slate-200/90 text-slate-900 font-bold hover:bg-white hover:border-purple-300 hover:scale-[1.02] duration-300 transition shadow-[0_4px_20px_rgba(0,0,0,0.05),inset_0_1px_1px_rgba(255,255,255,0.95)] hover:shadow-[0_6px_24px_rgba(124,58,237,0.18)]",
        appleGlass: "bg-gradient-to-r from-[#7C3AED] via-[#8B5CF6] to-[#A855F7] backdrop-blur-2xl border border-white/35 text-white font-bold hover:brightness-110 hover:border-white/60 hover:scale-[1.02] duration-300 transition shadow-[0_4px_20px_rgba(124,58,237,0.35),inset_0_1px_1px_rgba(255,255,255,0.5)]",
