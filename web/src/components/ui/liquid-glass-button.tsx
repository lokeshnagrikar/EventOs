  ...
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 ease-spring active:scale-[0.96] active:duration-75 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        brand: "bg-gradient-to-r from-[#7C3AED] via-[#9333EA] to-[#EC4899] backdrop-blur-2xl backdrop-saturate-[1.8] border border-white/40 text-white font-bold hover:brightness-110 hover:border-white/70 hover:scale-[1.02] duration-300 transition shadow-[0_8px_30px_rgba(124,58,237,0.4),inset_0_1px_1px_rgba(255,255,255,0.6)] hover:shadow-[0_12px_40px_rgba(124,58,237,0.55),inset_0_1px_1px_rgba(255,255,255,0.8)]",
        brandNavbar: "bg-gradient-to-r from-purple-50 via-indigo-50/80 to-pink-50/90 backdrop-blur-2xl backdrop-saturate-[1.8] border border-purple-200/90 text-[#111827] font-bold hover:bg-white hover:border-purple-400 hover:scale-[1.02] duration-300 transition shadow-[0_4px_20px_rgba(124,58,237,0.12),inset_0_1px_1px_rgba(255,255,255,0.95)] hover:shadow-[0_8px_28px_rgba(124,58,237,0.22)]",
        appleGlass: "bg-gradient-to-r from-[#7C3AED] via-[#9333EA] to-[#EC4899] backdrop-blur-2xl border border-white/40 text-white font-bold hover:brightness-110 hover:border-white/70 hover:scale-[1.02] duration-300 transition shadow-[0_4px_20px_rgba(124,58,237,0.4),inset_0_1px_1px_rgba(255,255,255,0.6)]",
        appleGlassLight: "bg-gradient-to-r from-white/90 via-purple-50/70 to-indigo-50/80 backdrop-blur-2xl border border-slate-200/90 text-slate-900 font-bold hover:bg-white hover:border-purple-300 hover:scale-[1.02] duration-300 transition shadow-[0_4px_16px_rgba(0,0,0,0.06),inset_0_1px_1px_rgba(255,255,255,0.95)]",
        destructive:
  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none z-10 flex items-center justify-center gap-2.5">
          {children}
        </div>
        <GlassFilter />
      </Comp>
