...
> [!NOTE]
> Alternatively, if you use Docker, running `docker-compose up postgres` will automatically execute [/docker/postgres/init-db.sql](file:///d:/EventOs/docker/postgres/init-db.sql) to provision these databases.
