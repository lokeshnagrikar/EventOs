...
public class EmailService {
    ...
    public void sendVerificationEmail(String toEmail, String token) {
        try {
            ...
            String htmlContent =
                ...
                "        <span style=\"font-size:38px; font-weight:900; letter-spacing:8px; color:#A78BFA; font-family:monospace;\">" + token + "</span>" +
                "      </div>" +
    ...
    public void sendInvitationEmail(String toEmail, String inviteToken, String inviteeName, String senderName, String roleName, String workspaceName, String frontendBaseUrl) {
        try {
            ...
            String htmlContent =
                ...
                "      <p style=\"margin-top:8px; font-size:15px; color:rgba(255,255,255,0.9);\">Join <strong>" + inviterDisplay + "</strong> in <strong>" + workspaceDisplay + "</strong></p>" +
                "    </td></tr>" +
                ...
                "        <strong style=\"color:white;\">" + inviterDisplay + "</strong> has invited you to join <strong style=\"color:#C4B5FD;\">" + workspaceDisplay + "</strong> as <strong style=\"color:#EC4899;\">" + roleDisplay + "</strong>. Accept the invite to start collaborating." +
                "      </p>" +
                "      <!-- CTA BUTTON -->" +
                "      <table width=\"100%\" style=\"margin:30px 0;\"><tr><td align=\"center\">" +
                "        <a href=\"" + acceptUrl + "\" style=\"display:inline-block; padding:18px 45px; border-radius:50px; background:linear-gradient(135deg,#8B5CF6,#EC4899); color:white; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 10px 20px rgba(139,92,246,0.3);\">🚀 Join Workspace</a>" +
                "      </td></tr></table>" +
    ...
    public void sendPasswordResetEmail(String toEmail, String token) {
        try {
            ...
            String htmlContent =
                ...
                "        <a href=\"" + resetUrl + "\" style=\"display:inline-block; padding:16px 36px; border-radius:16px; background:linear-gradient(135deg,#DC2626,#F59E0B); color:white; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 10px 20px rgba(220,38,38,0.3);\">🔑 Reset Password</a>" +
                "      </div>" +
    ...
    public void sendWelcomeEmail(String toEmail, String inviteeName, String workspaceName) {
        try {
            ...
            String htmlContent =
                ...
                "      <p style=\"margin-top:8px; font-size:15px; color:rgba(255,255,255,0.9);\">Welcome to <strong>" + workspaceDisplay + "</strong></p>" +
                "    </td></tr>" +
                "    <tr><td style=\"padding:40px;\">" +
                "      <p style=\"font-size:15px; color:#E4E4E7; font-weight:600;\">Hi " + displayName + " 👋</p>" +
                "      <p style=\"font-size:14px; line-height:1.8; color:#A1A1AA;\">" +
                ...
                "      <!-- CTA -->" +
                "      <table width=\"100%\" style=\"margin:30px 0;\"><tr><td align=\"center\">" +
                "        <a href=\"" + consoleUrl + "\" style=\"display:inline-block; padding:18px 45px; border-radius:50px; background:linear-gradient(135deg,#10B981,#3B82F6); color:white; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 10px 20px rgba(16,185,129,0.3);\">🚀 Open Console</a>" +
                "      </td></tr></table>" +
                "    </td></tr>" +
                "    <tr><td align=\"center\" style=\"padding:20px; background:#08080A; border-top:1px solid #27272A; font-size:11px; color:#52525B;\">" +
    ...
    public void sendMagicLinkEmail(String toEmail, String token) {
        try {
            ...
            String htmlContent =
                ...
                "      <div style=\"margin-bottom:28px;\">" +
                "        <a href=\"" + loginUrl + "\" style=\"display:inline-block; padding:18px 42px; border-radius:18px; background:linear-gradient(135deg,#8B5CF6,#EC4899); color:white; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 10px 20px rgba(139,92,246,0.35);\">🚀 Sign In to EventOS</a>" +
                "      </div>" +
    ...
    /* -------------------------------------------------------------------------- */
    @Async
    public void sendSubscriptionReceiptEmail(String toEmail, String ownerName, String planName, String amount, String currency, String invoiceNum, String pdfUrl) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            String sender = (fromAddress != null && !fromAddress.trim().isEmpty()) ? fromAddress : "billing@eventos.co";
            helper.setFrom(sender);
            helper.setTo(toEmail);
            ...
            String htmlContent =
                ...
                "      <h1 style=\"margin:8px 0 0; font-size:28px; color:#FFFFFF; font-weight:900;\">" + planName + " Plan Active</h1>" +
                "      <p style=\"margin-top:8px; font-size:14px; color:rgba(255,255,255,0.9);\">Receipt #" + invoiceNum + "</p>" +
                "    </td></tr>" +
                "    <tr><td style=\"padding:40px;\">" +
                "      <p style=\"font-size:15px; color:#E4E4E7; font-weight:600;\">Hi " + displayName + " 👋</p>" +
                "      <p style=\"font-size:14px; line-height:1.8; color:#A1A1AA;\">" +
                "        Thank you for subscribing to <strong style=\"color:#FBBF24;\">EventOS " + planName + "</strong>! Your payment of <strong style=\"color:white;\">" + currency + " " + amount + "</strong> has been processed successfully." +
                "      </p>" +
                "      <!-- RECEIPT SUMMARY -->" +
                ...
                "          <h3 style=\"margin:6px 0 14px; color:white; font-size:18px;\">" + planName + " Plan Subscription</h3>" +
                "          <table width=\"100%\" cellpadding=\"6\">" +
                "            <tr><td style=\"color:#A1A1AA; font-size:13px;\">Invoice Ref:</td><td align=\"right\" style=\"color:white; font-size:13px; font-family:monospace;\">" + invoiceNum + "</td></tr>" +
                "            <tr><td style=\"color:#A1A1AA; font-size:13px;\">Amount Paid:</td><td align=\"right\" style=\"color:#FBBF24; font-weight:800; font-size:14px;\">" + currency + " " + amount + "</td></tr>" +
                ...
                "      <!-- CTA -->" +
                "      <table width=\"100%\" style=\"margin:30px 0;\"><tr><td align=\"center\">" +
                "        <a href=\"" + (pdfUrl != null ? pdfUrl : frontendUrl + "/settings/billing") + "\" style=\"display:inline-block; padding:18px 45px; border-radius:50px; background:linear-gradient(135deg,#F59E0B,#7C3AED); color:white; font-size:15px; font-weight:800; text-decoration:none; box-shadow:0 10px 20px rgba(245,158,11,0.3);\">📄 Download Tax Invoice</a>" +
                "      </td></tr></table>" +
                "    </td></tr>" +
                "    <tr><td align=\"center\" style=\"padding:20px; background:#08080A; border-top:1px solid #27272A; font-size:11px; color:#52525B;\">" +
